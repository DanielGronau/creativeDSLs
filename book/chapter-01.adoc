...
* *Usability:* The DSL should be easy, safe and intuitive to use. It isn't enough to make a DSL concise, it should also take user expectations into account, and follow the principle of least astonishment. The error handling should be comprehensive and provide clear and informative error messages that help users identify and fix issues quickly.
