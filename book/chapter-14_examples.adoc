...
Better-parse is the parser-combinator library we used in <<#parser_library,Chapter 9>>. It features a succinct hybrid DSL, which gives you a lot of flexibility. Here is one of the example parsers of the project:
