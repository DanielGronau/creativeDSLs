...
I used https://www.deepl.com/write[DeepL Write] and https://openai.com/blog/chatgpt/[ChatGPT] by OpenAI as a writing assistants. As a non-native speaker, it is difficult to avoid grammar mistakes and to find to a natural writing style, and I'm thankful to DeepL and OpenAI for granting public access to their incredible technologies.
