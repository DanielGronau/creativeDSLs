...
To give you an idea of what using a parser library looks like, I rewrote the example code using the https://github.com/h0tk3y/better-parse[better-parse]footnote:[better-parse: https://github.com/h0tk3y/better-parse] project, which is an example of the parser-combinator approach:
