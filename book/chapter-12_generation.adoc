...
In the last chapter, we developed a little pattern matching DSL, however it lacked the ability to create pattern functions for data classes. In this case study, we will discuss just the annotation and the KSP visitor class, as the remaining parts are very similar to the previous case study.
