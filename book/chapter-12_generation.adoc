...
A popular library for generating Kotlin code is https://square.github.io/kotlinpoet[KotlinPoet]!footnote:kotlinpoet[KotlinPoet: https://square.github.io/kotlinpoet]. If you are also working with Java, you may also want to check out its sister project https://github.com/square/javapoet[JavaPoet]footnote:[JavaPoet: https://github.com/square/javapoet]. There is even some interoperability between them.
