...
As mentioned in link:chapter-04.adoc#annotations[4.10 Annotations], you might want to look into annotation processors, when you want to integrate your DSL somehow in the build process.
...
As it uses reflection, you need to include a dependency to the `kotlin-reflect` library, as described in chapter link:chapter-04#reflection[4.11 Reflection]. Of course, the example could be improved in many ways, e.g. sometimes you would need multiple source fields to calculate a target field.
