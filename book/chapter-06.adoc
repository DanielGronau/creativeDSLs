...
In the next section, we will look at an alternative implementation, which isn't as straightforward, but avoids the overhead of copying around data as much as in the chained builder approach above.
